...
export function WhatsAppButton() {
  ...
  const phone = "442412345678";
  const message = encodeURIComponent(
    "Hi! I would like to reserve a table at The Cue Club Coventry."
  );
  ...
  return (
    <a
      ...
      className={`
        ...
        backdrop-blur-md shadow-lg hover:border-emerald-400 hover:bg-emerald-900/90
